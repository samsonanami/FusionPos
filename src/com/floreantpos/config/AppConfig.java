...
public class AppConfig {
    ...
    public static String getDatabaseHost() {
        return config.getString(DATABASE_URL, "12.0.0.1"); //$NON-NLS-1$
    }
    ...
    public static String getConnectString() {
        return config.getString(CONNECTION_STRING, Database.MYSQL.getConnectString("", "", ""));  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
//	return config.getString(CONNECTION_STRING, Database.DERBY_SINGLE.getConnectString("", "", ""));  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public static String getDatabasePort() {
        return config.getString(DATABASE_PORT, "3307");
    }
    ...
    public static String getDatabaseName() {
        return config.getString(DATABASE_NAME, "laphilaBkp"); //$NON-NLS-1$
    }
    ...
    public static String getDatabaseUser() {
        return config.getString(DATABASE_USER, "root"); //$NON-NLS-1$
    }
    ...
    public static String getDatabasePassword() {
        return config.getString(DATABASE_PASSWORD, ""); //$NON-NLS-1$
    }
